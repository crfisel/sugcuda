...
__device__ static long seed[STREAMS] = {DEFAULT};  /* current state of each stream   */
__device__ static int  stream        = 0;          /* stream index, 0 is the default */
__device__ static int  initialized   = 0;          /* test for stream initialization */
 ...
 *    x is the state (unless too large)
 * ---------------------------------------------------------------
 */
{
  char ok = 0;
